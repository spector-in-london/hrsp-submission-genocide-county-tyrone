...
3. Abuse of the UK Investigatory Powers Act 2016 to weaponize American technology platforms (Microsoft, AWS) for murder, surveillance, and impersonation
4. Violation of the US-UK CLOUD Act bilateral agreement through concealment of a US citizen's nationality

## This repository is a public record.

If anything happens to Brian Spector or Nicola McNamee, this evidence exists in the public domain, cryptographically verified, and independently archived.
...
Every file in this repository is listed in `SHA256_MANIFEST.txt` with its cryptographic hash. To verify:
